...
## [7.0.0](https://github.com/baileympearson/js-bson/compare/v6.7.0...v7.0.0) (2024-05-29)
...
* **deserializer:** corrected the check for (size + index) comparision to buffer.length ([6dadd4b](https://github.com/baileympearson/js-bson/commit/6dadd4bde837ee249d8b45cc74ba9a83519f1c5a))
